...
def generate_report(model, X_train, X_test, y_train, y_test, X, y, feature_names, metrics, best_params, class_weight_dict, best_threshold):
    try:
...
if __name__ == "__main__":
    ...
    generate_report(best_model, X_train, X_test, y_train, y_test, X_scaled, y, feature_names, metrics, best_params, class_weight_dict, best_threshold)
